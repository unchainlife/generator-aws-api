...
class AppGenerator extends BaseGenerator {
  constructor(args, opts) {
    ...
    this._input({ name: "dev_account_id",     type: "input", message: "dev account (multi-account only)" });
    this._input({ name: "test_account_id",    type: "input", message: "test account (multi-account only)" });
    this._input({ name: "prod_account_id",    type: "input", message: "prod account (multi-account only)" });
  }
